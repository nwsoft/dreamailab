...
const faqItems: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: '네. 자동 일지, 이상 알림, 병원용 리포트 초안, 카메라 관찰, 행동 번역, 추천 엔진, API 연동은 기존 AI Core를 재사용하면 기술적으로 구현 가능한 모듈입니다. 로봇 Brain 연동은 장기 Future Vision입니다.',
  },
  {
  ...
  {
    q: '로봇 연동은 언제쯡 가능한가요?',
    a: '정해진 출시 일정은 없습니다. Robot Vision은 Digital Care Log가 축적된 이후를 가정하는 장기 Future Vision 단계로 구분해서 안내하고 있습니다.',
  },
]
...
const buildableModules: { title: string; desc: string; icon: MarketingIconName; status: ModuleStatus }[] = [
  {
    title: '자동 일지 생성',
  ...
  {
    title: '로봇 Brain (Future)',
    desc: '돌봄 로봇의 판단 엔진으로 확장하는 장기 비전입니다. 현재는 연구 개념 단계입니다.',
    icon: 'robot',
    status: 'future',
  },
]
      ...
      <section id="modules" className="scroll-mt-28 py-14 bg-white border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-gray-600 text-sm max-w-3xl mx-auto mb-10">
            ...
            재사용하면, 아래 모듈들은 기술적으로 바로 구현에 착수할 수 있는 범위입니다. 로봇 Brain만 장기
            Future Vision으로 구분합니다.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
