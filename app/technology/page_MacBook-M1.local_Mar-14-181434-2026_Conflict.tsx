...
export const metadata: Metadata = {
  title: '핵심 기술 - AI 디지털케어로그 | 드림에이아이랩',
  description:
    '드림에이아이랩의 독자기술 AI 디지털케어로그: 창업자 정해성이 최초 고안한 기술로 사람의 활동 데이터를 표준화→AI 분석→실행 연결→환류(학습)로 잇는 범용 인프라. 발달장애, 치매연구, 노인질병에 최초 적용하여 의료·돌봄·교육을 넘어 HR·스포츠·모빌리티 등 다양한 도메인으로 확장됩니다.',
  keywords:
    '드림에이아이랩, DAL, AI 디지털케어로그, 디지털케어로그, 정해성, 창업자, 개발자, 독자기술, 최초고안, 발달장애, 치매연구, 노인질병, 의료헬스케어, 정신심리치료, 임상혁신, RWE, 신약개발, 토탈케어로그, 글로벌커플케어, 베지케어, 치매, 항암, 데이터표준화, AI분석',
}
...
export default function Technology() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-primary-600 to-secondary-600 text-white py-20 md:py-24 shadow-inner">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">AI 디지털케어로그</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              DAL의 독자 기술인 <strong>AI 디지털케어로그</strong>는 행동·학습·치료·반응·생활습관·임상 데이터 등 
      ...
      <section className="py-16 lg:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">왜 AI 디지털케어로그인가?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
  디지털케어로그는 의료·돌봄·교육을 넘어, 사람이 기록하거나 발생시키는 모든 행위를 데이터화하여 AI로 최적화할 수 있는 <strong>범용 플랫폼</strong>입니다. 즉, 특정 산업에 국한되지 않고 인간 활동 전반에 적용 가능한 <strong>확장성</strong>을 지닙니다. 이러한 확장성을 바탕으로, 현장 시스템 전반의 한계를 <strong>데이터 표준화와 AI</strong>로 단계적으로 개선합니다.
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">AI 디지털케어로그의 핵심 기술이 어떻게 작동하는지 구체적으로 설명합니다</p>
          </div>
            ...
            <div className="mt-10 text-center">
              <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                ...
                <p className="text-gray-700 max-w-3xl mx-auto">
                  ...
                  개인별 맞춤형 계획을 생성하는 강력한 AI 디지털케어로그 시스템을 구축합니다.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              AI 디지털케어로그의 본질은 “사람의 행위·경험·상태를 기록 → AI 분석 → 맞춤형 최적화 → 집단지능 학습”입니다.
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-r from-primary-600 to-secondary-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-6">AI 디지털케어로그로 현장 데이터의 미래를 만듭니다</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto text-white/90">
            독자기술로 분산된 현장 데이터를 표준화하고 AI로 RWE(현장 근거) 기반 혁신을 실현합니다 — 파트너와 함께 새로운 기준을 만들어가요.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/business" className="bg-white text-primary-600 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors text-lg">
              비즈니스·투자
            </Link>
            <Link href="/contact" className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-primary-600 transition-colors text-lg">
              기술 문의
            </Link>
          </div>
        </div>
