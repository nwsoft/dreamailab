...
export const metadata: Metadata = {
  title: '회사소개 - AI 디지털케어로그로 표준을 만드는 드림에이아이랩',
  description: 'DAL은 자체 개발한 AI 디지털케어로그로 의료·돌봄·교육 데이터를 통합해 개인 맞춤 케어를 제안하는 표준 플랫폼을 만듭니다. 사회적 문제 해결과 확장 가능한 비즈니스를 동시에 실현합니다.',
  keywords: '드림에이아이랩, 회사소개, AI 디지털케어로그, 시장 선점, 표준화, 사회적가치, 투자, 혁신',
  openGraph: {
    title: '회사소개 - AI 디지털케어로그로 표준을 만드는 드림에이아이랩',
    description: 'DAL은 자체 개발한 AI 디지털케어로그로 의료·돌봄·교육 데이터를 통합해 개인 맞춤 케어를 제안하는 표준 플랫폼을 만듭니다. 사회적 문제 해결과 확장 가능한 비즈니스를 동시에 실현합니다.',
...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto">
              아무도 가지 않은 길이기에 우리가 합니다.<br />
              사회적 약자의 삶을 개선하는 동시에, 글로벌 헬스·돌봄·교육의 새로운 표준을 만듭니다.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                DAL(Dream AI Lab)은 모든 사람이 언제 어디서나 동등하게 의료·돌봄·교육 서비스를 누릴 수 있도록, 자체 개발한 ‘AI 디지털케어로그’ 기술을 기반으로 솔루션을 제공합니다. 가정·학교·병원·기관 데이터를 하나로 통합하고 AI가 분석하여 개인별 맞춤 치료·학습·돌봄 계획을 제안합니다.
              </p>
              <p className="text-lg text-gray-600 mb-6">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-primary-100 to-secondary-100 rounded-2xl p-8">
                <div className="text-center">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">우리의 목표</h3>
                  <p className="text-gray-600 mb-6">
                    기술을 통해 사회적 가치를 창출하고, 더 나은 미래를 구축하는 데 전념합니다.
                  </p>
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-primary-600 mb-2">8+</div>
                      <div className="text-gray-600">AI 서비스</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-secondary-600 mb-2">1000+</div>
      ...
      {/* Core Technology: AI 디지털케어로그 */}
      <section className="py-16 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">Our Core Technology: AI 디지털케어로그</h2>
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-br from-blue-50 to-cyan-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">4 Flagship Domains</h2>
            <p className="text-lg text-gray-600">핵심 4개 도메인을 요약 카드로 확인하세요. 자세한 내용은 각 상세 페이지에서 보실 수 있습니다.</p>
          </div>
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-r from-primary-600 to-secondary-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto text-gray-100">
            AI 디지털케어로그를 기반으로 자람이·시니어앤라이프·의료헬스케어·국제결혼을 확장하고 있습니다. 함께 표준을 만들 파트너를 찾습니다.
          </p>
