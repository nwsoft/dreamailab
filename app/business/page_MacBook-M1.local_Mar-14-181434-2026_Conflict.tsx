...
export const metadata: Metadata = {
  ...
  description: 'DAL의 핵심기술 AI 디지털케어로그 기반의 B2B 솔루션, 파트너십, 투자 포인트를 확인하세요. 창업자 정해성이 최초 고안한 디지털케어로그 기술로 표준을 선도하는 검증된 포트폴리오와 사회적 임팩트를 제시합니다.',
...
export default function Business() {
  ...
  const investmentHighlights = [
    {
      title: '독점적 시장 확장성',
      description: '4대 독점 축을 기반으로 시장을 빠르게 확장',
      icon: '🎯',
      details: [
        '발달장애·시니어·국제결혼·베지터리안 4대 독점 축 형성',
    ...
    {
      title: '독점 기술 & 진입장벽',
      description: 'AI 디지털케어로그 기반 표준화·규제 적합성',
      icon: '🥇',
      details: [
...
AI 디지털케어로그 기반 표준 플랫폼으로 파트너와 함께 성장합니다.
4대 독점 축(발달·시니어·국제결혼·베지터리안)을 바탕으로
사회적 가치와 수익성을 동시에 실현합니다.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
  <div className="bg-white/10 rounded-xl p-6 border border-white/20">
    <div className="text-sm text-white/90">핵심 포지션</div>
    <div className="text-2xl font-bold text-white mt-1">4대 독점 축</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              4대 <strong className="text-gray-800">독점 시장</strong>(발달장애·시니어·국제결혼·베지터리안)에서 
              표준화를 추진하고 있습니다.
            </p>
          </div>
