...
export default function HealthcareService() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero 직후: 한 줄 요약 + 대상 독자 (시니어·에듀 스타일) */}
      <section className="py-8 bg-teal-50/80 border-b border-teal-100">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-xs font-semibold text-teal-800 mb-2">[한 줄 요약]</p>
          <p className="text-gray-900 font-medium text-sm md:text-base leading-relaxed">
            병원 밖 일상의 증상·복약·생활이 <strong>같은 케어로그</strong>에 남고, AI가 분석·권고까지 이어{' '}
            <strong>다음 진료·연계</strong>로 연결되도록 설계한 <strong>DAL 헬스케어AI</strong>입니다.
          </p>
        </div>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
          ...
          <ul className="grid sm:grid-cols-2 gap-2 text-sm text-gray-700">
            <li className="flex gap-2">
              ...
              <span>
                만성질환·복약·수면·활동을 <strong>매일 짧게 남기고</strong> 진료 때 설명하고 싶은 <strong>환자·가족</strong>
              </span>
            </li>
            <li className="flex gap-2">
              <span className="text-teal-600 shrink-0">•</span>
              <span>
                내원 전후 <strong>생활 경과</strong>를 같은 형식으로 받아보고 싶은 <strong>병원·약국·케어 기관</strong>
              </span>
            </li>
            <li className="flex gap-2">
              <span className="text-teal-600 shrink-0">•</span>
              <span>
                항암·정신건강 등 <strong>집중 관리 모드</strong>와 리포트가 필요한 <strong>특수 상황 케어</strong>
              </span>
            </li>
            <li className="flex gap-2">
              <span className="text-teal-600 shrink-0">•</span>
              <span>
                표준 로그·RWE·과제 연계를 논의하려는 <strong>연구·공공·제약</strong> 담당자
              </span>
            </li>
          </ul>
      ...
      <section className="py-14 bg-gray-50 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-xs font-semibold text-teal-700 mb-2">[한 줄 요약]</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              <h3 className="font-bold text-gray-900 mb-2">🔗 매칭·연계 채널</h3>
              <p className="text-sm text-gray-700">
                자람이·시니어앤라이프에서 쌓은 매칭·연계 경험을 헬스케어 시나리오에 맞게 재사용합니다. 도입 기관은 파일럿 범위에서 우선 연결을 설계할 수 있습니다.
              </p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              <h3 className="font-bold text-gray-900 mb-2">📊 표준 스키마</h3>
              <p className="text-sm text-gray-700">
