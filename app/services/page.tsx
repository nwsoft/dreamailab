...
export const metadata: Metadata = {
  title: '서비스 생태계 - 하나의 플랫폼 위 도메인 확장 | 드림에이아이랩',
  description: 'DAL의 모든 서비스는 AI디지털케어로그 기반 하나의 플랫폼 위에 연결됩니다. 발달장애·시니어·의료·교육·글로벌패밀리·라이프스타일·금융 도메인 생태계를 확인하세요.',
...
const platforms = [
  ...
  },
  {
    ...
    status: '파일럿 운영 중',
    icon: '🎓',
    summary: 'AI디지털케어로그를 교육에 응용한 개별화 학습 플랫폼 - 새로운 교육 패러다임 창출',
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-6 text-center">
              ...
              <div className="bg-white/20 rounded-lg p-4 border border-white/30">
                ...
                <div className="text-sm text-white/80">도메인 확장</div>
              </div>
              <div className="bg-white/20 rounded-lg p-4 border border-white/30">
                <div className="text-2xl font-bold">{monopolyCount}</div>
                <div className="text-sm text-white/80">시장 선도</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center">
            <div className="text-center mb-8">
              <h2 className="text-xl font-bold text-gray-900 mb-2">플랫폼 연결 구조</h2>
              <p className="text-gray-600">모든 서비스는 동일한 데이터 표준으로 연결됩니다.</p>
            </div>
      ...
      <main className="py-20 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
          ...
          <Section 
            title="플랫폼 위 도메인 확장" 
            subtitle="AI디지털케어로그 기반으로 연결된 도메인별 서비스. 각 도메인은 동일한 데이터 표준을 공유합니다."
          ...
          <Section 
            title="플랫폼 기반 기술" 
            subtitle="모든 도메인 서비스의 공통 기반 — 데이터 표준화와 AI 분석으로 연결 구조를 구축합니다"
            badge="Core"
          >
      ...
      <section className="py-20 bg-gradient-to-r from-primary-600 to-secondary-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            함께 성장하는 플랫폼 생태계를 만들어가요
          </h2>
          <p className="text-xl mb-8 text-white/90">
            투자, 파트너십, 서비스 도입 문의를 환영합니다.
          </p>
